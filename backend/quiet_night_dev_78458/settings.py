"""
Django settings for quiet_night_dev_78458 project.
...
ROOT_URLCONF = 'quiet_night_dev_78458.urls'
...
WSGI_APPLICATION = 'quiet_night_dev_78458.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_night_dev_78458 API",
    "DESCRIPTION": "API documentation for quiet_night_dev_78458 App",
    "VERSION": "v1",
}
